...
public class CursedRegistry {
    ...
    /**
     * FoodComponent objects can only be made through their builder class since the constructor method is private.
     * FoodComponent objects are used to apply food values to an item
     */

    public static final FoodComponent FNUNGUS = (new FoodComponent.Builder()).hunger(2).saturationModifier(0.5F).build();
    ...
    public static final Item CRIMSON_FNUNGUS= new Item(new Item.Settings().group(ItemGroup.FOOD).food(FNUNGUS));
    public static final Item WARPED_FNUNGUS= new Item(new Item.Settings().group(ItemGroup.FOOD).food(FNUNGUS));


    public static final Item TBPI_ITEM=new BlockItem(TBPI, new Item.Settings().group(ItemGroup.MISC));

    /**
     * RecipeType objects have to be made with the registry function since much of the RecipeType class is private
     */
    ...
    public static void register(){
        ...
        Registry.register(Registry.ITEM, getID("crimson_fnungus"), CRIMSON_FNUNGUS);
        Registry.register(Registry.ITEM, getID("warped_fnungus"), WARPED_FNUNGUS);
        /**
