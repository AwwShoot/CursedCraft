...
public class TreeStandFeature extends StructureFeature<DefaultFeatureConfig> {
    public TreeStandFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
            ...
            TreeStandGenerator.addPieces(manager, pos, rotation, this.children);
